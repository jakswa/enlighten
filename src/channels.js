module.exports = function(app) {
  ...
  app.service('plugs').publish('created', () => app.channel('anonymous'));
  app.service('lights').publish('patched', () => app.channel('anonymous'));
  app.service('lights').publish('updated', () => app.channel('anonymous'));
};
